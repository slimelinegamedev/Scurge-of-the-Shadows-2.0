Shader "Custom/BloomShaderLens" {
	...
	fixed4 frag (v2f i) : COLOR
	{
		...
		fixed4 lens = tex2D(_LensTex, i.uv);
		...
		col = (col) * _BloomColor;
		lens = lens * _LensAmount;
		return col * lens + main;
	}
	ENDCG
