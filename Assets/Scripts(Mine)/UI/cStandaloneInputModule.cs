...
namespace UnityEngine.EventSystems {
	[AddComponentMenu("Event/cInput Standalone Input Module")]
	public class cStandaloneInputModule : PointerInputModule {
		...
		protected cStandaloneInputModule () {
		}
		...
		public override bool IsModuleSupported() {
			...
			// to use cStandaloneInputModule for non-touch input events.
		...
		public override bool ShouldActivateModule() {
			...
			var shouldActivate = cInput.GetButtonDown(m_SubmitButton);
